...
function changeSourceDone() {
  console.log('changeSourceDone ')
  // this.$store.dispatch('editImage', {oldPath: this.selectedVisual.filename, newPath: this.newFilenameSelected, imageSize: this.selectedVisual.imageSize })
  // this.newFilenameSelected = undefined
}
