      ...
      <div class="player" :class="{'active': playerIsActive}">
        <div class="controlsInner">
          <div class="playerBtn" id="prevBtn" @click="skipTrack('prev')">
            <svg width="25px" height="19px" viewBox="0 0 25 19" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="0.900928442">
                    <g id="Desktop-HD-Copy-3" transform="translate(-49.000000, -1142.000000)" fill="#000000">
                        <g id="player" transform="translate(0.000000, 1112.000000)">
                            <g id="Group-4" transform="translate(49.000000, 23.000000)">
                                <g id="Group-2" transform="translate(12.500000, 15.833333) rotate(-180.000000) translate(-12.500000, -15.833333) translate(0.000000, 6.333333)">
          ...
          <div class="controlsCenter">
            <div id="loading" v-if="waitingMusic">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;display:block;" width="30px" height="30px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                <circle cx="50" cy="50" fill="none" stroke="#313131" stroke-width="10" r="40" stroke-dasharray="188.49555921538757 64.83185307179586">
          ...
          <div class="playerBtn" id="nextBtn" @click="skipTrack('next')">
            ...
            <svg width="25px" height="19px" viewBox="0 0 25 19" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="0.900928442">
                  <g id="Desktop-HD-Copy-3" transform="translate(-144.000000, -1142.000000)" fill="#000000">
                      <g id="player" transform="translate(0.000000, 1112.000000)">
                          <g id="Group-4" transform="translate(49.000000, 23.000000)">
        ...
        <div class="progressInner">
          ...
          <div id="timer" class="timer">{{ trackInfo.seek | minutes }}</div>
          ...
          <div id="duration" class="timer" v-if="playingSource != 'stream'">{{ trackInfo.duration | minutes }}</div>
        </div>
...
import { Howler } from 'howler';
  export default {
    ...
    computed: {
      playingSource() {
         return this.$store.getters['getPlaylistSource']
      },
      trackProgress () {
        //console.log('this.progress * 100 ', this.progress * 100)
